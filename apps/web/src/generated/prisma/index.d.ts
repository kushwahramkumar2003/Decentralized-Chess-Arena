...
export namespace Prisma {
  ...
  */
  ...
  export type WaitlistUserOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "handle" | "createdAt", ExtArgs["result"]["waitlistUser"]>
  ...
  interface WaitlistUserFieldRefs {
    ...
    readonly handle: FieldRef<"WaitlistUser", 'String'>
  ...
  export type WaitlistUserWhereInput = {
    ...
    handle?: StringFilter<"WaitlistUser"> | string
  ...
  export type WaitlistUserScalarWhereWithAggregatesInput = {
    ...
    handle?: StringWithAggregatesFilter<"WaitlistUser"> | string
